...
class DeepRM_TC_NO_CONTEXT(nn.Module):
    '''
    NARRE: WWW 2018
    '''
    def __init__(self, opt):
        super(DeepRM_TC_NO_CONTEXT, self).__init__()
        self.opt = opt
    ...
    def forward(self, datas):
        ...
        u_fea = self.dropout(torch.sum(user_att_review_embedding, 1))  # [batch, review_hidden_size]
        i_fea = self.dropout(torch.sum(item_att_review_embedding, 1)) # [batch, review_hidden_size]
